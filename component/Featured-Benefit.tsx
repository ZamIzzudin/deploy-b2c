        ...
        <div className={`${styles['benefit-container']} my-5`}>
            <div className={styles.debug1}>
                <div className={`${styles['benefit-card']} card`}>
                    <i className="fa-solid fa-rss fa-2x org-icon"></i>
            ...
            <div className={styles.debug3}>
                <div className={`${styles['benefit-card']} card`}>
                    <i className="fa-solid fa-shield-halved fa-2x org-icon"></i>
            ...
            <div className={styles.debug4}>
                <div className={`${styles['benefit-card']} card`}>
                    <i className="fa-solid fa-arrows-turn-to-dots fa-2x org-icon"></i>
            ...
            <div className={styles.debug5}>
                <div className={`${styles['benefit-card']} card`}>
                    <i className="fa-solid fa-headset fa-2x org-icon"></i>
